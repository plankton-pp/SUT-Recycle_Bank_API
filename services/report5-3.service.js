    ...
    return new Promise(async (resolve, reject) => {        
        if(!year){
            try {
                ...
                LEft JOIN (SELECT date_format(FROM_UNIXTIME(placedetail.Create_Date),'%M %Y') as month,Product_ID as Product_Used,sum(Unit) FROM "placedetail" GROUP BY Product_ID) f
